...
#define STRING_CONFIG_H_AUTHOR "(LVD-AC, MELVIN CH'NG)" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_RADIUS 151.19 //(DELTA_SMOOTH_ROD_OFFSET-DELTA_EFFECTOR_OFFSET-DELTA_CARRIAGE_OFFSET)
  
  //========================ADDED END===================================

  // height from z=0 to home position
  #define DELTA_HEIGHT 336.02 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.41, 0.0, -1.36 } // get these from auto calibrate
  
  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.10, -0.02, 0.0 } // get these values from auto calibrate
...
#define INVERT_E0_DIR true //E3D V6
